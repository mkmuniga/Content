...
def upload_pmc(input_file_path, output_dir):
    schema = table_schema()
    schema.add_record_schema('PMC', [
        field(name='TIME', type=FieldType.UINT),
        field(name='POWER_STATUS', type=FieldType.STRING),
        field(name='CSTATE', type=FieldType.STRING),
        field(name='CCFPWRDNCONTROLFSM', type=FieldType.STRING),
        field(name='CCFPWRUPCONTROLFSM', type=FieldType.STRING),
        field(name='CCFGVCONTROLFSM', type=FieldType.STRING),
        field(name='LLCCTRLFSM', type=FieldType.STRING),
        field(name='MONITORCPFSM', type=FieldType.STRING),
        field(name='PMCLOCKFSM', type=FieldType.STRING),
        field(name='CFICTRLFSM', type=FieldType.STRING),
    ])
