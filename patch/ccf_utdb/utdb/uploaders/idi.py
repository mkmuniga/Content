...
def upload_idi(input_file_path, output_dir):
    schema = table_schema()
    schema.add_record_schema('idi', [
        ...
        field(name='OPCODE', type=FieldType.STRING),
        field(name='TYPE', type=FieldType.STRING),
        field(name='HASH', type=FieldType.STRING),
        field(name='CQID', type=FieldType.STRING),
        field(name='UQID', type=FieldType.STRING),
        field(name='LPID'),
        field(name='SRC_TGT', type=FieldType.STRING),
        field(name='PARITY', type=FieldType.STRING),
        field(name='PAR_ERR', type=FieldType.STRING),
        field(name='DATA_ER', type=FieldType.STRING),
        field(name='POISON', type=FieldType.STRING),
        field(name='TRACE', type=FieldType.STRING),
        field(name='ATTR', type=FieldType.STRING),
        field(name='CHUNK'),
        field(name='DATA', type=FieldType.STRING),
        field(name='SPARE', type=FieldType.STRING),
