...
def upload_preload(input_file_path, output_dir):
    schema = table_schema()
    schema.add_record_schema('PRELOAD', [
        ...
        field(name='PRF_VUL', type=FieldType.STRING),
        field(name='DATA', type=FieldType.STRING),
        field(name='POISON', type=FieldType.STRING),
        field(name='ECC', type=FieldType.STRING),
        field(name='TAG', type=FieldType.STRING),
        field(name='LRU', type=FieldType.STRING),
        field(name='DATA_ER', type=FieldType.STRING),
        field(name='TAG_ER', type=FieldType.STRING),
        field(name='STMAP_ER', type=FieldType.STRING),
        field(name='CV_ER', type=FieldType.STRING),
    ])
...
def match_and_upload(input_file_path, output_dir, utdb_name):
    ...
    pattern_to_uploader_dict = {
        '^ccf_preload_trk.log*$': upload_preload,
    }
